...
/**
 * MysqlUtil contains many values that are needed for communication with the
 * MySQL server.
 *
...
public final class MysqlUtil {
    ...
    public static int mysqlToJavaType(int mysqlType) {
        ...
        switch (mysqlType) {
            case MysqlUtil.FIELD_TYPE_NEW_DECIMAL:
            case MysqlUtil.FIELD_TYPE_DECIMAL:
                jdbcType = Types.DECIMAL;

                break;

            case MysqlUtil.FIELD_TYPE_TINY:
                jdbcType = Types.TINYINT;

                break;

            case MysqlUtil.FIELD_TYPE_SHORT:
                jdbcType = Types.SMALLINT;

                break;

            case MysqlUtil.FIELD_TYPE_LONG:
                jdbcType = Types.INTEGER;

                break;

            case MysqlUtil.FIELD_TYPE_FLOAT:
                jdbcType = Types.REAL;

                break;

            case MysqlUtil.FIELD_TYPE_DOUBLE:
                jdbcType = Types.DOUBLE;

                break;

            case MysqlUtil.FIELD_TYPE_NULL:
                jdbcType = Types.NULL;

                break;

            case MysqlUtil.FIELD_TYPE_TIMESTAMP:
                jdbcType = Types.TIMESTAMP;

                break;

            case MysqlUtil.FIELD_TYPE_LONGLONG:
                jdbcType = Types.BIGINT;

                break;

            case MysqlUtil.FIELD_TYPE_INT24:
                jdbcType = Types.INTEGER;

                break;

            case MysqlUtil.FIELD_TYPE_DATE:
                jdbcType = Types.DATE;

                break;

            case MysqlUtil.FIELD_TYPE_TIME:
                jdbcType = Types.TIME;

                break;

            case MysqlUtil.FIELD_TYPE_DATETIME:
                jdbcType = Types.TIMESTAMP;

                break;

            case MysqlUtil.FIELD_TYPE_YEAR:
                jdbcType = Types.DATE;

                break;

            case MysqlUtil.FIELD_TYPE_NEWDATE:
                jdbcType = Types.DATE;

                break;

            case MysqlUtil.FIELD_TYPE_ENUM:
                jdbcType = Types.CHAR;

                break;

            case MysqlUtil.FIELD_TYPE_SET:
                jdbcType = Types.CHAR;

                break;

            case MysqlUtil.FIELD_TYPE_TINY_BLOB:
                jdbcType = Types.VARBINARY;

                break;

            case MysqlUtil.FIELD_TYPE_MEDIUM_BLOB:
                jdbcType = Types.LONGVARBINARY;

                break;

            case MysqlUtil.FIELD_TYPE_LONG_BLOB:
                jdbcType = Types.LONGVARBINARY;

                break;

            case MysqlUtil.FIELD_TYPE_BLOB:
                jdbcType = Types.LONGVARBINARY;

                break;

            case MysqlUtil.FIELD_TYPE_VAR_STRING:
            case MysqlUtil.FIELD_TYPE_VARCHAR:
                jdbcType = Types.VARCHAR;

                break;

            case MysqlUtil.FIELD_TYPE_STRING:
                jdbcType = Types.CHAR;

                break;
            case MysqlUtil.FIELD_TYPE_GEOMETRY:
                jdbcType = Types.BINARY;

                break;
            case MysqlUtil.FIELD_TYPE_BIT:
                jdbcType = Types.BIT;
    ...
    public static int mysqlToJavaType(String mysqlType) {
        if (mysqlType.equalsIgnoreCase("BIT")) {
            ...
            return mysqlToJavaType(FIELD_TYPE_INT24);
                ...
                mysqlType.equalsIgnoreCase("INTEGER")) { //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public static final void appendJdbcTypeMappingQuery(StringBuffer buf, String mysqlTypeColumnName) {
    ...
    public static String getClassNameForJavaType(int javaType, TDHSResponseEnum.FieldType mysqlType) {
        ...
        switch (javaType) {
            ...
            case Types.SMALLINT:
                return "java.lang.Integer"; //$NON-NLS-1$
            case Types.INTEGER:
                if (mysqlTypeIfKnown == MysqlUtil.FIELD_TYPE_INT24) {
                    return "java.lang.Integer"; //$NON-NLS-1$
                }
            ...
            case Types.LONGVARBINARY:
                ...
                if (mysqlTypeIfKnown == MysqlUtil.FIELD_TYPE_GEOMETRY) {
                    return "[B";
                } else {
